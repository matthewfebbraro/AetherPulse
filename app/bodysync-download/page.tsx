...
export default function LandingPage() {
    ...
    return (
        ...
        />
            ...
            justify-center  
            overflow-hidden">
                                    <p className="absolute h-full w-full bg-indigo-900/40" />
                        ...
                        <div>
                            ...
                            <div className="overflow-y-auto h-[380px]">
                                <div className="p-4 text-white space-y-2 text-center">
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Track for Free</p>
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Gamified Experience</p>
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Experience Points</p>
                                    <p>- ExpSync (with friends)</p>
                                    <p>- ExpStore (unlock customizables)</p>
                                    <p>- ExpOverview (point allocation)</p>
                                    <p>- ExpLevels</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Daily Motivational Quote</p>
                                    <p>- Daily Motivational in-app Notifications.</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">SyncSimulator</p>
                                    <p>- in depth TDEE calculator powered by FusionCore.</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">HydroSync</p>
                                    <p>- Water tracking</p>
                                    <p>- set a daily Water goal to achieve.</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">DawnSync</p>
                                    <p>- Weight Tracking & set a weight Goal (or disable weight goal)</p>
                                    <p>- Sleep Duration Tracking</p>
                                    <p>- Sleep Quality Tracking</p>
                                    <p>- RecoveryTDEE</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">DuskSync</p>
                                    <p>- Steps Tracking</p>
                                    <p>- exercise Minutes Tracking</p>
                                    <p>- ActiveTDEE Tracking</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Daily Energy Burn</p>
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">SyncReport</p>
                                    <p>- Visual Trends & graphs For Daily Syncs.</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">SyncAnalysis</p>
                                    <p>- Your data quantified to help you better understand your habits.</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Hidden Glyphs Game</p>
                                    <p className="text-[18px] font-semibold">--Coming Soon--</p>
                                    <p>- Find and unlock 12 color themes and backgrounds</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Nighthawk mode</p>
                        ...
                        <div>
                            ...
                            <div className="overflow-y-auto h-[380px]">
                                <div className="p-4 text-white space-y-2 text-center">
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">$5.00 Subscription</p>
                                    <p>- Unlock every premium feature for only $5/month. No grind, no hidden costs — just tools to push your progress further</p>

                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Fitness Tracker</p>
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1">Nutrition Log</p>
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30  rounded-xl pb-1">Daily Tasks</p>
                                    ...
                                    <p className="text-[28px] font-semibold bg-indigo-800/30  rounded-xl pb-1">Hidden Glyph Game</p>
                                    <p className="text-[18px] font-semibold">--Coming Soon--</p>
                        ...
                        <div>
                            ...
                            <div className="p-4 overflow-y-auto h-[380px]">
                                <div className="text-white space-y-2 text-center">
                                    <p className="text-[18px] pt-2 pb-3 px-3 font-semibold bg-indigo-900/40  rounded-xl pb-1 text-center  text-lg italic mt-2">
                                        Scroll down to access your download & installation guide.
                                    </p>
                                    <p className="text-[28px] font-semibold bg-indigo-800/30 rounded-xl pb-1"></p>
                                    <p>
                                ...
                                <div className="mt-2 max-w-sm z-10 flex bg-indigo-900/40 rounded-xl justify-center h-[85px] z-20 w-full flex items-center 
            justify-center bg-contain bg-center bg-no-repeat bg-[url('/images/android-banner.png')] ">
                                ...
                                <div className="mt-2 bg-indigo-900/30  rounded-xl p-4 text-white space-y-2 text-sm">
                                ...
                                <button
                                    ...
                                    className="bg-indigo-900/40 relative mt-2 max-w-sm w-full z-10 flex rounded-xl justify-center h-[85px] z-20 flex-col w-full flex items-center 
            justify-center 
            overflow-hidden">
                    ...
                    <div className="absolute bottom-1 px-1 flex flex-row justify-center w-full">
                        <button
                            ...
                            className="mr-1 w-[50%]  rounded-xl bg-indigo-800/30  px-4 py-1 text-white transition text-center text-[18px] font-semibold">
                            {Page === "1" && <p></p>}
                            {Page === "2" && <p>Prev</p>}
                            {Page === "3" && <p>Prev</p>}
                            {Page === "4" && <p>Prev</p>}
                        ...
                        <button
                            ...
                            className="ml-2 w-[50%]   rounded-xl bg-indigo-800/30  px-4 py-1 text-white transition text-center text-[18px] font-semibold">
                            {Page === "1" && <p>Next</p>}
                            {Page === "2" && <p>Next</p>}
                            {Page === "3" && <p>Next</p>}
                            {Page === "4" && <p></p>}
