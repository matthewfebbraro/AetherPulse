...
<div className="flex flex-col items-center h-[98dvh]" >            <div
            ...
            <div className="w-full relative">
                ...
                <div className="relative h-[65px]    flex flex-col items-center justify-center bg-indigo-800/50">
                   
                    <div className="absolute text-[40px] text-white font-semibold  pb-1">Biometrics</div>
                </div>
            </div>
            ...
            <footer className="-900 text-white py-4 mt-auto">
